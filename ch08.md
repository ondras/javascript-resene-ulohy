...
Typickým způsobem, jak předat hodnotu `this` zároveň s callbackem, je vytvoření uzávěry. Můžeme to udělat buď ručně, nebo pomocí arrow funkcí, jejichž specifiké pravidlo s `this` je pro nás užitečné:
