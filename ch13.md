...
Druhý parametr je prázdný. Pokud by náš kód v C potřeboval přístup k některým JS funkcím, poskytli bychom mu je právě v druhém parametru funkce `instantiate`. Exportovaná funkcionalita je pro nás nyní dostupná v proměnné `wasm`:
