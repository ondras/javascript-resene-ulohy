...
Zvídavý čtenář nyní může objekt `console` prozkoumat (například voláním `console.log(console)`) a&nbsp;najít tak spoustu dalších užitečných funkcí. O&nbsp;všech se následně může dočíst třeba na webu MDN (viz dále).
