...
Cílem knihy je nabídnout užitečný obsah všem zájemcům o JavaScript. Projděte si prvních pár kapitol a *nakalibrujte se* na jednoho ze tří vzorových čtenářů -- podle toho pak můžete další podkapitolám věnovat větší pozornost, nebo je jen v rychlosti prolétnout a přeskočit.
